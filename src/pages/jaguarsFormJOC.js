...
const jaguarsFormJOC= () => {
  return (
    <>
    <Head>
        <title>Jaguars | ENTER TO WIN PROMO (JOC) - Play Fun Inc</title>
        <link rel="icon" href="/favicon.png" />
        {/* <meta name="description" content=""/> */}
        <meta property="og:title" content="Jaguars | ENTER TO WIN PROMO (JOC) - Play Fun Inc"/>
        ...
        <meta property="og:url" content="https://www.playfuninc.org/jaguarsFormJOC"/>
